...
<body class="bg-gray-100">
  ...
  <div id="item1" class="carousel-item w-full">
    <img src="{{ asset('image/slide3.jpeg') }}" class="w-full" />
  </div> 
  <div id="item2" class="carousel-item w-full">
    <img src="{{ asset('image/slide4.jpg') }}" class="w-full" />
  </div> 
  <div id="item3" class="carousel-item w-full">
    <img src="{{ asset('image/slide5.webp') }}" class="w-full" />
  </div> 
  <div id="item4" class="carousel-item w-full">
    <img src="{{ asset('image/slide6.jpeg') }}" class="w-full" />
  </div>
</div> 
